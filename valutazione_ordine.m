...
Qui si vuole procedere con la determinazione dell'ordine a priori, 
a partire dal quale si cercherà di ottenere il miglior modello ARX o 
eventualmente ARMAX, e realizzazione dell'andamento dell'autovalore 
minimo in funzione di n.
